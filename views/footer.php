    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2">
                    <i class="fa fa-map-marker-alt me-3"></i>12 Chùa Bộc, Đống Đa,
                    Hà Nội
                </p>
                <p class="mb-2">
                    <i class="fa fa-phone-alt me-3"></i>02438521851
                </p>
                <p class="mb-2">
                    <i class="fa fa-envelope me-3"></i>phongdaotao@hvnh.edu.vn
                </p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p>Nếu bạn có bất kì mong muốn nào, hãy liên hệ với chúng tôi</p>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">BA's Best Hpot</a><!--, All
                    Right Reserved.-->
